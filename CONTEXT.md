...
Compiled 2026-08-29 PT. Recency ranked. Sources: CURRENT.md (ChatGPT project dump, Aug 29 2026 History Dump plus Apr 29 and Mar 31 chats), HISTORY.md (Gmail, Drive, realmzmobile.com), weekendwatch-github-demo-dump.md (GitHub + live demo). Claude in-product chats have not been searched.
...
This file is the durable recency-ranked product context. Verbatim ChatGPT dumps, Gmail/Drive timeline, and the GitHub/demo dump live with the WeekendWatch product agent, not in this repo (this repo is public).
...
- Whether to resume any hardware, the web sim, or stay on thesis/spec next.
